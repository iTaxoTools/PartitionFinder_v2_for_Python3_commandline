...
from . import phyml_models as models
...
class Parser(object):
    ...
    def parse(self, text):
        ...
        try:
            #print(text)
            #print(self.root_parser)
            #print(dir(self.root_parser))
            tokens = self.root_parser.parseString(text.decode('latin-1'), parseAll=False)
            #type(print(tokens))
